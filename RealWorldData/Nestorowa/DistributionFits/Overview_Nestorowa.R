...
#wenn names()um which.min bekommt man die Wörter sonst Zahlen/Faktoren wie jetzt im moment (einfach durchnummeriert)

# One big data.frame: Rows are genes, Columns are all informations of the Fits, all params, the logliks, the BIC
