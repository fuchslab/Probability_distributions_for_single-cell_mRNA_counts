#goodness of fit tests Nestorowa
...
Overview_Nestorowa <- data.frame( row.names=list_all )

Overview_Nestorowa$Pois_lambda <- Pois_lambda
Overview_Nestorowa$Pois_value <- Pois_value
Overview_Nestorowa$Pois_conv <- Pois_conv
Overview_Nestorowa$Pois_BIC <- Pois_BIC

Overview_Nestorowa$NB_size <- NB_par[,"size"]
Overview_Nestorowa$NB_mu <-  NB_par[,"mu"]
Overview_Nestorowa$NB_value <- NB_value
Overview_Nestorowa$NB_conv <- NB_conv
Overview_Nestorowa$NB_BIC <- NB_BIC

Overview_Nestorowa$PIG_size <- PIG_par[,"mu"]
Overview_Nestorowa$PIG_mu <-  PIG_par[,"sigma"]
Overview_Nestorowa$PIG_value <- PIG_value
Overview_Nestorowa$PIG_conv <- PIG_conv
Overview_Nestorowa$PIG_BIC <- PIG_BIC

Overview_Nestorowa$PB_alpha <- PB_par[,"alpha"]
Overview_Nestorowa$PB_beta <-  PB_par[,"beta"]
Overview_Nestorowa$PB_c <-  PB_par[,"c"]
Overview_Nestorowa$PB_value <- PB_value
Overview_Nestorowa$PB_conv <- PB_conv
Overview_Nestorowa$PB_BIC <- PB_BIC

Overview_Nestorowa$DEL_mu <- DEL_par[,"mu"]
Overview_Nestorowa$DEL_sigma <-  DEL_par[,"sigma"]
Overview_Nestorowa$DEL_nu <-  DEL_par[,"nu"]
Overview_Nestorowa$DEL_value <- DEL_value
Overview_Nestorowa$DEL_conv <- DEL_conv
Overview_Nestorowa$DEL_BIC <- DEL_BIC

Overview_Nestorowa$ZIPois_p <- ZIPois_par[,"p"]
Overview_Nestorowa$ZIPois_lambda <- ZIPois_par[,"lambda"]
Overview_Nestorowa$ZIPois_value <- ZIPois_value
Overview_Nestorowa$ZIPois_conv <- ZIPois_conv
Overview_Nestorowa$ZIPois_BIC <- ZIPois_BIC

Overview_Nestorowa$ZINB_p <- ZINB_par[,"p"]
Overview_Nestorowa$ZINB_size <- ZINB_par[,"size"]
Overview_Nestorowa$ZINB_mu <-  ZINB_par[,"mu"]
Overview_Nestorowa$ZINB_value <- ZINB_value
Overview_Nestorowa$ZINB_conv <- ZINB_conv
Overview_Nestorowa$ZINB_BIC <- ZINB_BIC

Overview_Nestorowa$ZIPIG_p <- ZIPIG_par[,"p"]
Overview_Nestorowa$ZIPIG_size <- ZIPIG_par[,"mu"]
Overview_Nestorowa$ZIPIG_mu <-  ZIPIG_par[,"sigma"]
Overview_Nestorowa$ZIPIG_value <- ZIPIG_value
Overview_Nestorowa$ZIPIG_conv <- ZIPIG_conv
Overview_Nestorowa$ZIPIG_BIC <- ZIPIG_BIC

Overview_Nestorowa$ZIPB_p <- ZIPB_par[,"p"]
Overview_Nestorowa$ZIPB_alpha <- ZIPB_par[,"alpha"]
Overview_Nestorowa$ZIPB_beta <-  ZIPB_par[,"beta"]
Overview_Nestorowa$ZIPB_c <-  ZIPB_par[,"c"]
Overview_Nestorowa$ZIPB_value <- ZIPB_value
Overview_Nestorowa$ZIPB_conv <- ZIPB_conv
Overview_Nestorowa$ZIPB_BIC <- ZIPB_BIC

Overview_Nestorowa$ZIDEL_p <- ZIDEL_par[,"p"]
Overview_Nestorowa$ZIDEL_mu <- ZIDEL_par[,"mu"]
Overview_Nestorowa$ZIDEL_sigma <-  ZIDEL_par[,"sigma"]
Overview_Nestorowa$ZIDEL_nu <-  ZIDEL_par[,"nu"]
Overview_Nestorowa$ZIDEL_value <- ZIDEL_value
Overview_Nestorowa$ZIDEL_conv <- ZIDEL_conv
Overview_Nestorowa$ZIDEL_BIC <- ZIDEL_BIC

Overview_Nestorowa$Pois2_p <- Pois2_par[,"p"]
Overview_Nestorowa$Pois2_lambda1 <- Pois2_par[,"lambda_1"]
Overview_Nestorowa$Pois2_lambda2 <- Pois2_par[,"lambda_2"]
Overview_Nestorowa$Pois2_value <- Pois2_value
Overview_Nestorowa$Pois2_conv <- Pois2_conv
Overview_Nestorowa$Pois2_BIC <- Pois2_BIC

Overview_Nestorowa$NB2_p <- NB2_par[,"p"]
Overview_Nestorowa$NB2_size1 <- NB2_par[,"size_1"]
Overview_Nestorowa$NB2_mu1 <-  NB2_par[,"mu_1"]
Overview_Nestorowa$NB2_size2 <- NB2_par[,"size_2"]
Overview_Nestorowa$NB2_mu2 <-  NB2_par[,"mu_2"]
Overview_Nestorowa$NB2_value <- NB2_value
Overview_Nestorowa$NB2_conv <- NB2_conv
Overview_Nestorowa$NB2_BIC <- NB2_BIC

Overview_Nestorowa$PIG2_p <- PIG2_par[,"p"]
Overview_Nestorowa$PIG2_size1 <- PIG2_par[,"mu_1"]
Overview_Nestorowa$PIG2_mu1 <-  PIG2_par[,"sigma_1"]
Overview_Nestorowa$PIG2_size2 <- PIG2_par[,"mu_2"]
Overview_Nestorowa$PIG2_mu2 <-  PIG2_par[,"sigma_2"]
Overview_Nestorowa$PIG2_value <- PIG2_value
Overview_Nestorowa$PIG2_conv <- PIG2_conv
Overview_Nestorowa$PIG2_BIC <- PIG2_BIC

Overview_Nestorowa$PB2_p <- PB2_par[,"p"]
Overview_Nestorowa$PB2_alpha1 <- PB2_par[,"alpha_1"]
Overview_Nestorowa$PB2_beta1 <-  PB2_par[,"beta_1"]
Overview_Nestorowa$PB2_c1 <-  PB2_par[,"c_1"]
Overview_Nestorowa$PB2_alpha2 <- PB2_par[,"alpha_2"]
Overview_Nestorowa$PB2_beta2 <-  PB2_par[,"beta_2"]
Overview_Nestorowa$PB2_c2 <-  PB2_par[,"c_2"]
Overview_Nestorowa$PB2_value <- PB2_value
Overview_Nestorowa$PB2_conv <- PB2_conv
Overview_Nestorowa$PB2_BIC <- PB2_BIC

Overview_Nestorowa$DEL2_p <- DEL2_par[,"p"]
Overview_Nestorowa$DEL2_mu1 <- DEL2_par[,"mu_1"]
Overview_Nestorowa$DEL2_sigma1 <-  DEL2_par[,"sigma_1"]
Overview_Nestorowa$DEL2_nu1 <- DEL2_par[,"nu_1"]
Overview_Nestorowa$DEL2_mu2 <- DEL2_par[,"mu_2"]
Overview_Nestorowa$DEL2_sigma2 <-  DEL2_par[,"sigma_2"]
Overview_Nestorowa$DEL2_nu2 <- DEL2_par[,"nu_2"]
Overview_Nestorowa$DEL2_value <- DEL2_value
Overview_Nestorowa$DEL2_conv <- DEL2_conv
Overview_Nestorowa$DEL2_BIC <- DEL2_BIC

Overview_Nestorowa$ZIPois2_p1 <- ZIPois2_par[,"p_1"]
Overview_Nestorowa$ZIPois2_p2 <- ZIPois2_par[,"p_2"]
Overview_Nestorowa$ZIPois2_lambda1 <- ZIPois2_par[,"lambda_1"]
Overview_Nestorowa$ZIPois2_lambda2 <- ZIPois2_par[,"lambda_2"]
Overview_Nestorowa$ZIPois2_value <- ZIPois2_value
Overview_Nestorowa$ZIPois2_conv <- ZIPois2_conv
Overview_Nestorowa$ZIPois2_BIC <- ZIPois2_BIC

Overview_Nestorowa$ZINB2_p1 <- ZINB2_par[,"p_1"]
Overview_Nestorowa$ZINB2_p2 <- ZINB2_par[,"p_2"]
Overview_Nestorowa$ZINB2_size1 <- ZINB2_par[,"size_1"]
Overview_Nestorowa$ZINB2_mu1 <-  ZINB2_par[,"mu_1"]
Overview_Nestorowa$ZINB2_size2 <- ZINB2_par[,"size_2"]
Overview_Nestorowa$ZINB2_mu2 <-  ZINB2_par[,"mu_2"]
Overview_Nestorowa$ZINB2_value <- ZINB2_value
Overview_Nestorowa$ZINB2_conv <- ZINB2_conv
Overview_Nestorowa$ZINB2_BIC <- ZINB2_BIC

Overview_Nestorowa$ZIPIG2_p1 <- ZIPIG2_par[,"p_1"]
Overview_Nestorowa$ZIPIG2_p2 <- ZIPIG2_par[,"p_2"]
Overview_Nestorowa$ZIPIG2_size1 <- ZIPIG2_par[,"mu_1"]
Overview_Nestorowa$ZIPIG2_mu1 <-  ZIPIG2_par[,"sigma_1"]
Overview_Nestorowa$ZIPIG2_size2 <- ZIPIG2_par[,"mu_2"]
Overview_Nestorowa$ZIPIG2_mu2 <-  ZIPIG2_par[,"sigma_2"]
Overview_Nestorowa$ZIPIG2_value <- ZIPIG2_value
Overview_Nestorowa$ZIPIG2_conv <- ZIPIG2_conv
Overview_Nestorowa$ZIPIG2_BIC <- ZIPIG2_BIC

Overview_Nestorowa$ZIPB2_p1 <- ZIPB2_par[,"p_1"]
Overview_Nestorowa$ZIPB2_p2 <- ZIPB2_par[,"p_2"]
Overview_Nestorowa$ZIPB2_alpha1 <- ZIPB2_par[,"alpha_1"]
Overview_Nestorowa$ZIPB2_beta1 <-  ZIPB2_par[,"beta_1"]
Overview_Nestorowa$ZIPB2_c1 <-  ZIPB2_par[,"c_1"]
Overview_Nestorowa$ZIPB2_alpha2 <- ZIPB2_par[,"alpha_2"]
Overview_Nestorowa$ZIPB2_beta2 <-  ZIPB2_par[,"beta_2"]
Overview_Nestorowa$ZIPB2_c2 <-  ZIPB2_par[,"c_2"]
Overview_Nestorowa$ZIPB2_value <- ZIPB2_value
Overview_Nestorowa$ZIPB2_conv <- ZIPB2_conv
Overview_Nestorowa$ZIPB2_BIC <- ZIPB2_BIC

Overview_Nestorowa$ZIDEL2_p1 <- ZIDEL2_par[,"p_1"]
Overview_Nestorowa$ZIDEL2_p2 <- ZIDEL2_par[,"p_2"]
Overview_Nestorowa$ZIDEL2_mu1 <- ZIDEL2_par[,"mu_1"]
Overview_Nestorowa$ZIDEL2_sigma1 <-  ZIDEL2_par[,"sigma_1"]
Overview_Nestorowa$ZIDEL2_nu1 <- ZIDEL2_par[,"nu_1"]
Overview_Nestorowa$ZIDEL2_mu2 <- ZIDEL2_par[,"mu_2"]
Overview_Nestorowa$ZIDEL2_sigma2 <-  ZIDEL2_par[,"sigma_2"]
Overview_Nestorowa$ZIDEL2_nu2 <- ZIDEL2_par[,"nu_2"]
Overview_Nestorowa$ZIDEL2_value <- ZIDEL2_value
Overview_Nestorowa$ZIDEL2_conv <- ZIDEL2_conv
Overview_Nestorowa$ZIDEL2_BIC <- ZIDEL2_BIC


Overview_Nestorowa$model <- comparison_all
Overview_Nestorowa$modelname <- comparison_all_name





save(Overview_Nestorowa,file="Overview_Nestorowa.rds")
