...
sum(Nestorowa_GOF$x2_adj[Nestorowa_GOF$comparison_all_name=="del"])
plot(Nestorowa_GOF$`unlist(GOF_x2)`[Nestorowa_GOF$comparison_all_name=="del"])
...
sum(Nestorowa_GOF$x2_adj[Nestorowa_GOF$comparison_all_name=="del2"])
plot(Nestorowa_GOF$`unlist(GOF_x2)`[Nestorowa_GOF$comparison_all_name=="del2"])
...
sum(Nestorowa_GOF$x2_adj[Nestorowa_GOF$comparison_all_name=="zidel"])
plot(Nestorowa_GOF$`unlist(GOF_x2)`[Nestorowa_GOF$comparison_all_name=="zidel"])
...
sum(Nestorowa_GOF$x2_adj[Nestorowa_GOF$comparison_all_name=="zidel2"])
plot(Nestorowa_GOF$`unlist(GOF_x2)`[Nestorowa_GOF$comparison_all_name=="zidel2"])
...
save(Nestorowa_GOF, file="Result_Nestorowa_BIC_GOF.rda")
