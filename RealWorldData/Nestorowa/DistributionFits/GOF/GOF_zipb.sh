#!/bin/bash
#SBATCH --output=/storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/nestorowa/GOF/GOF_zipb.out
#SBATCH --error=/storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/nestorowa/GOF/GOF_zipb.err
#SBATCH -J GOF_ZIpb
#SBATCH -p icb_cpu
...
# `sbatch GOF_zipb.sh`
# and needs the file GOF_zipb_inner.sh
...
ch-run -b /storage/groups/:/storage/groups/  -b /storage/groups/:/storage/groups  /localscratch/${USER}/r3.5.2packages_scmodels/ -- /bin/bash /storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/nestorowa/GOF/GOF_zipb_inner.sh
