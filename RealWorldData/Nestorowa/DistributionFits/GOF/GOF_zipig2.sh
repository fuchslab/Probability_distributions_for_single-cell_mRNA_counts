#!/bin/bash
#SBATCH --output=/storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/nestorowa/GOF/GOF_zipig2.out
#SBATCH --error=/storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/nestorowa/GOF/GOF_zipig2.err
#SBATCH -J GOF_ZIPIG2
#SBATCH -p icb_cpu
...
# `sbatch GOF_zipig2.sh`
# and needs the file GOF_zipig2_inner.sh
...
ch-run -b /storage/groups/:/storage/groups/  -b /storage/groups/:/storage/groups  /localscratch/${USER}/r3.5.2packages_scmodels/ -- /bin/bash /storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/nestorowa/GOF/GOF_zipig2_inner.sh
