#!/bin/bash
#SBATCH --output=/storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/mm10/mm10/GOF/GOF_del2.out
#SBATCH --error=/storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/mm10/mm10/GOF/GOF_del2.err
#SBATCH -J GOF_del2
#SBATCH -p icb_cpu
...
# `sbatch GOF_del2.sh`
# and needs the file GOF_del2_inner.sh
...
ch-run -b /storage/groups/:/storage/groups/  -b /storage/groups/:/storage/groups  /localscratch/${USER}/r3.5.2packages_scmodels/ -- /bin/bash /storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/mm10/mm10/GOF/GOF_del2_inner.sh
