...
for(id in names(which(comparison_all_name=="zipb2")) ){
    ...
    p1 <- dpb2(0:max(main_data[id,]),p_1=Par[[id]][1],p_2=Par[[id]][1],alpha1=Par[[id]][3], beta1= Par[[id]][4],c1=Par[[id]][5], alpha2= Par[[id]][6], beta2= Par[[id]][7], c2= Par[[id]][8])
    ...
    save(p_ks,p_x2, file="p_gof_zipb2.rda")
}
