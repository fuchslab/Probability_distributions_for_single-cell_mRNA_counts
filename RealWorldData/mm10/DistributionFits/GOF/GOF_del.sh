#!/bin/bash
#SBATCH --output=/storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/mm10/mm10/GOF/GOF_del.out
#SBATCH --error=/storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/mm10/mm10/GOF/GOF_del.err
#SBATCH -J GOF_del
#SBATCH -p icb_cpu
...
# `sbatch GOF_del.sh`
# and needs the file GOF_del_inner.sh
...
ch-run -b /storage/groups/:/storage/groups/  -b /storage/groups/:/storage/groups  /localscratch/${USER}/r3.5.2packages_scmodels/ -- /bin/bash /storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/mm10/mm10/GOF/GOF_del_inner.sh
