#!/bin/bash
#SBATCH --output=/storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/mm10/mm10/GOF/GOF_zidel.out
#SBATCH --error=/storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/mm10/mm10/GOF/GOF_zidel.err
#SBATCH -J GOF_ZIdel
#SBATCH -p icb_cpu
...
# `sbatch GOF_zidel.sh`
# and needs the file GOF_zidel_inner.sh
...
ch-run -b /storage/groups/:/storage/groups/  -b /storage/groups/:/storage/groups  /localscratch/${USER}/r3.5.2packages_scmodels/ -- /bin/bash /storage/groups/biostat01/projects/Lisa_ProbDistr/RealWorld/mm10/mm10/GOF/GOF_zidel_inner.sh
