#!/bin/bash
#SBATCH --output=/storage/groups/biostat01/projects/Lisa_ProbDistr/PerfectWorld/FitData/BasicBurst/output/Fit_arrayJob_%A_%a.out
#SBATCH --error=/storage/groups/biostat01/projects/Lisa_ProbDistr/PerfectWorld/FitData/BasicBurst/output/Fit_arrayJob_%A_%a.err
#SBATCH -J BasicBurst_Fit_GOF
#SBATCH -p icb_cpu
...
# `sbatch basicburst.sh`
# and needs the file basicburst_inner.sh
...
ch-run -b /storage/groups/:/storage/groups/  -b /storage/groups/:/storage/groups  /localscratch/${USER}/r3.5.2packages_scmodels/ -- /bin/bash /storage/groups/biostat01/projects/Lisa_ProbDistr/PerfectWorld/FitData/BasicBurst/basicburst_inner.sh
