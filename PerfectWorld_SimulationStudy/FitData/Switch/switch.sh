#!/bin/bash
#SBATCH --output=/storage/groups/biostat01/projects/Lisa_ProbDistr/PerfectWorld/FitData/Switch/output/Fit_arrayJob_%A_%a.out
#SBATCH --error=/storage/groups/biostat01/projects/Lisa_ProbDistr/PerfectWorld/FitData/Switch/output/Fit_arrayJob_%A_%a.err
#SBATCH -J Switch_Fit_GOF
#SBATCH -p icb_cpu
...
# `sbatch switch.sh`
# and needs the file switch_inner.sh
...
ch-run -b /storage/groups/:/storage/groups/  -b /storage/groups/:/storage/groups  /localscratch/${USER}/r3.5.2packages_scmodels/ -- /bin/bash /storage/groups/biostat01/projects/Lisa_ProbDistr/PerfectWorld/FitData/Switch/switch_inner.sh
